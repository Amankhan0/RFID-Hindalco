...
public class ReplaceToActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_replace_to);

        sessionManager = new SessionManager(this);

        apiCallBackWithToken = new ApiCallBackWithToken(this);

        if(sessionManager.getReplaceSecondScan() == null){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_MAIN_ACTIVITY) {
            if (resultCode == RESULT_OK) {
                ...
                try {
                    if (result != null) {
                        ...
                        if (tagArr.length() > 0) {
                            ...
                            Intent intent = new Intent(this, ReplaceMainActivity.class);
                    ...
                    startActivity(intent);
                    runOnUiThread(() -> {
                        Toast.makeText(ReplaceToActivity.this, "Operation failed due to JSON error", Toast.LENGTH_LONG).show();
                    });
                ...
                startActivity(intent);
                runOnUiThread(() -> {
                    Toast.makeText(ReplaceToActivity.this, "Operation cancelled", Toast.LENGTH_LONG).show();
                });
            }
        }
    }
