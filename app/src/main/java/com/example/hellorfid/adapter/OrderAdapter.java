...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder> {
    ...
    private List<String> nonClickableStatuses;
    ...
    public OrderAdapter(Context context, List<OrderModel> orderList, OnOrderClickListener listener) {
        ...
        this.nonClickableStatuses = getNonClickableStatuses();
    }

    private List<String> getNonClickableStatuses() {
        String selectedOption = sessionManager.getOptionSelected();
        List<String> statuses = new ArrayList<>();

        if (selectedOption.equals(Constants.INBOUND)) {
            statuses.add(Constants.ORDER_RECEIVED);
            statuses.add(Constants.ORDER_PICKED);
        } else if (selectedOption.equals(Constants.OUTBOUND)) {
            statuses.add(Constants.ORDER_PICKED);
            statuses.add(Constants.ORDER_RECEIVED);

        } else if (selectedOption.equals(Constants.RECHECK)) {
            statuses.add(Constants.RECHECKED);
        }
