...
import com.example.hellorfid.adapter.DispatchAdapter;
...
public class DispatchActivity extends AppCompatActivity {
    ...
    private DispatchAdapter buildingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildingAdapter = new DispatchAdapter(this, buildingModels);
        ...
        ProfileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DispatchActivity.this, ProfileActivity.class);
    ...
    private void parseAndDisplayBuildings(JSONObject responseJson) {
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                buildingModels.add(new DispatchModel(id, name, address));
            }
